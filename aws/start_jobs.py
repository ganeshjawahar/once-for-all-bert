...
def dataset_factory(name):
    ...
    datasets["wikibooks_acabert_bertbaseuncased_128len"] = "/fsx/ganayu/data/academic_bert_dataset/bert_preproc_128" 
    datasets["wikibooks_acabert_robertabase_128len"] = "/fsx/ganayu/data/academic_bert_dataset/roberta_preproc_128" 
